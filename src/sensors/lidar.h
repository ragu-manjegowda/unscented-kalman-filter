...
struct Ray
{
     ...
     * up resoultion: the magnitude of the ray's step, used for ray casting, the smaller
...
struct Lidar
{
    ...
    ~Lidar()
    {
        // pcl uses boost smart pointers for cloud pointer so we don't have to worry about
